...
public class Posttest7 extends javax.swing.JFrame {
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
        ...
        String judul = txtJudul.getText(); //variabel judul mengambil nilai yang terdapat pada componen fjudul 
        String penulis = comboPenulis.getSelectedItem().toString(); //variabel penulis mengambil nilai yang terdapat pada componen cpenulis
        String harga = txtHarga.getText(); //variabel harga mengambil nilai yang terdapat pada componen fharga
        cekkosong();
    ...
    private void UbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UbahActionPerformed
        ...
        try {
            ...
            jTable1.setValueAt(txtJudul.getText(), baris, 1);//script untuk mengganti nilai pada jtable baris 1
            jTable1.setValueAt(comboPenulis.getSelectedItem(), baris, 2);//script untuk mengganti nilai pada jtable baris 2
            jTable1.setValueAt(txtHarga.getText(), baris, 3);//script untuk mengganti nilai pada jtable baris 3
